...
It also reinforced that reliability engineering matters as much as the feature itself. The three-layer error handling and offline tests mean the app works even when the API doesn't swhich is exactly the kind of robustness a real system needs.
